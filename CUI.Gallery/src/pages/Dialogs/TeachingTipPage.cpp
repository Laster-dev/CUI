...
Element BuildTeachingTipPage() {
    ...
    CUI::DSL::Borrow(btnCloseOnly).BackgroundToken(ThemeTokenId::CardBackground);
    CUI::DSL::Borrow(btnCloseOnly).ForegroundToken(ThemeTokenId::TextPrimary);
    CUI::DSL::Borrow(btnCloseOnly).BorderToken(ThemeTokenId::CardBorder);
    CUI::DSL::Borrow(btnCloseOnly).BorderThickness(1.0f);
    ...
    CUI::DSL::Borrow(btnPlacementTop).Width(90.0f);
    CUI::DSL::Borrow(btnPlacementBottom).Width(90.0f);
    CUI::DSL::Borrow(btnPlacementLeft).Width(90.0f);
    CUI::DSL::Borrow(btnPlacementRight).Width(90.0f);

    auto makeDirectionTip = [](UIElement* src, BubblePlacement p, const std::string& label) {
        auto tip = TeachingTipWidget();
        CUI::DSL::Borrow(tip).Title(label);
    ...
    CUI::DSL::Borrow(btnAuto).BackgroundToken(ThemeTokenId::CardBackground);
    CUI::DSL::Borrow(btnAuto).ForegroundToken(ThemeTokenId::TextPrimary);
    CUI::DSL::Borrow(btnAuto).BorderToken(ThemeTokenId::CardBorder);
    CUI::DSL::Borrow(btnAuto).BorderThickness(1.0f);
