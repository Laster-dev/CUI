...
Element BuildFilePickerPage() {
    ...
    // 1. 基础文件选择器
    // ==========================================
    CUI::Widgets::Ref picker1 = Widgets::FilePicker()
        .Shared();
    picker1.Path("E:\\C++project\\CUI\\CUI.Core\\ui\\framework\\core\\CUIDsl.h");
        picker1.DialogTitle("选择目标代码源文件");
        picker1.Filter("C++ 源码文件 (*.cpp;*.h;*.hpp)", "*.cpp;*.h;*.hpp");
    ...
    auto btnCppFilter = Button("切换为 C++ 源码过滤")
        .OnClick([picker1, statusLabel](UIElement*) {
                        picker1.Filter("C++ 源码 (*.cpp;*.h)", "*.cpp;*.h");
                        picker1.Path("E:\\C++project\\CUI\\CUI.Core\\ui\\framework\\controls\\Button.cpp");
            statusLabel->Text = "已应用【C++ 源码】类型过滤器 (*.cpp;*.h)";
        });

    auto btnMediaFilter = Button("切换为图像资源过滤")
        .OnClick([picker1, statusLabel](UIElement*) {
                        picker1.Filter("图像资源 (*.png;*.jpg;*.svg;*.ico)", "*.png;*.jpg;*.svg;*.ico");
                        picker1.Path("E:\\C++project\\CUI\\assets\\icons\\app_logo.png");
            statusLabel->Text = "已应用【图像资源】类型过滤器 (*.png;*.jpg;*.svg)";
        });

    auto btnDocFilter = Button("切换为 Markdown 文档过滤")
        .OnClick([picker1, statusLabel](UIElement*) {
                        picker1.Filter("Markdown 说明文档 (*.md;*.txt)", "*.md;*.txt");
                        picker1.Path("E:\\C++project\\CUI\\README.md");
...
CUI::Widgets::Ref picker = Widgets::FilePicker("C:\\Projects\\App\\main.cpp")
    .Shared();

// 2. 配置对话框标题与文件类型扩展名过滤器
picker.DialogTitle("选择 C++ 源文件");
picker.Filter("C++ 文件 (*.cpp;*.h)", "*.cpp;*.h");
